<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
        <img src="{{ asset('assets/backend/dist/img/avatar5.png') }}" alt="Ecommerce"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item menu-open">
                    <a href="{{ route('backend.dashboard') }}"
                        class="nav-link {{ 'admin' == request()->path() ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('subcategory.create') }}"
                                class="nav-link {{ request()->is('subcategory/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create</p>
                            </a>
                        </li>
                ...
                <li class="nav-item menu-open">
                    <a href="{{ route('setting.create') }}"
                        class="nav-link {{ 'setting' == request()->path() ? 'active' : '' }}">
                ...
                <li class="nav-item menu-open">
                    <a href="{{route('user_profile.index')}}"
                        class="nav-link {{ 'user-profile' == request()->path() ? 'active' : '' }}">
